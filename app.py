...
mongodb_user = os.environ.get('MONGO_USER', 'root')  # Username from your docker-compose
mongodb_password = os.environ.get('MONGO_PASSWORD', 'password')  # Password from your docker-compose
